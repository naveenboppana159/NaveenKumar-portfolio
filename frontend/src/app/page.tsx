      ...
      <header className="header">
        <nav className="container header-content">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <a 
              href="/public/Naveen_Full_Stack_Developer_3Years (1).pdf"
        ...
        <div className={`mobile-menu-dropdown ${isMobileMenuOpen ? 'open' : ''}`}>
          ...
          <a href="/public/Naveen_Full_Stack_Developer_3Years (1).pdf" download="Naveen_Kumar_Boppana_Resume.pdf" className="header-btn" style={{ textAlign: 'center', marginTop: '1rem' }} onClick={() => setIsMobileMenuOpen(false)}>
            Resume
          </a>
        </div>
      </header>
          ...
          <div className="hero-grid">
            <div className="reveal">
              ...
              <p className="font-body-lg text-on-surface-variant" style={{ maxWidth: '36rem' }}>
                ...
                <span className="text-primary">React.js, Next.js, React Native, Django, Python, PostgreSQL, Git, GitHub, Docker, LLM, RAG, GCP, CICD, Agile, Redis, and CockroachDB.</span>
              </p>
            ...
            <div className="timeline">
              ...
              <div className="timeline-item reveal">
                <div className="timeline-side-content">
                  <span className="text-primary font-code" style={{ fontSize: '0.875rem' }}>Jun 2024 - Present</span>
              ...
              <div className="timeline-item reverse reveal">
                <div className="timeline-side-content">
                  <span className="text-secondary font-code" style={{ fontSize: '0.875rem' }}>Dec 2023 - Jun 2024</span>
